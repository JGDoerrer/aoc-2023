...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `58.7µs` | `1.1ms` |
| [Day 2](./src/bin/02.rs) | `31.5µs` | `54.3µs` |
| [Day 3](./src/bin/03.rs) | `4.8ms` | `5.7ms` |
| [Day 4](./src/bin/04.rs) | `201.0µs` | `200.4µs` |
| [Day 5](./src/bin/05.rs) | `43.0µs` | `98.8µs` |
| [Day 6](./src/bin/06.rs) | `521.0ns` | `256.0ns` |
| [Day 7](./src/bin/07.rs) | `297.9µs` | `298.4µs` |
